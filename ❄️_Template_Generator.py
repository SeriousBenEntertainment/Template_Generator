...
# Show options
submitted, chapters,  table_of_contents, paragraph_of_summary, table_of_glossar, table_of_stakeholders, table_of_attachments = frontend_options(cloud, df, minio_client)
